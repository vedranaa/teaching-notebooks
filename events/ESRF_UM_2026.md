...
The notebooks may be found on the github repository [https://github.com/vedranaa/teaching-notebooks](https://github.com/vedranaa/teaching-notebooks). You may download the notebooks and run from your machine. For this, you will need to install all modules the code uses and make small modifications when getting data or mounting google drive. 
